...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '12d470cb1ef580d7b8e6dc59b16b41a3,en:12d470cb1ef580d7b8e6dc59b16b41a3',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mint', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '进阶中的空间魔法师！', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://gamer-mint.life', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/86243492', // B站主页
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ming813771413@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_POST_PREVIEW_LINES || 0, // 预览博客行数
